...
public enum ErrorCode {
	...
	INVALID_CREDENTIALS(HttpStatus.UNAUTHORIZED, "AUTH-40100", "이메일 또는 비밀번호가 올바르지 않습니다."),
	...
	INVALID_TOKEN_PAYLOAD(HttpStatus.UNAUTHORIZED, "AUTH-40104","토큰의 사용자 정보가 올바르지 않습니다."),
